                ...
                <div class="dlabnav-scroll">
                    <ul class="metismenu" id="menu">
                        ...
                        <li><a class="ai-icon" href="{{url('dashboard')}}" aria-expanded="false">
                            <i class="fa-solid fa-chart-column"></i><span class="nav-text">Dashboard</span>
                            </a>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" class="mm-collapse">
                                ...
                                <li><a href="{{url('business')}}">Bisnis / Usaha</a></li>
                            </ul>
                        </li>
                        <li><a class="ai-icon" href="{{url('transaction')}}" aria-expanded="false">
