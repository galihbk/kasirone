  ...
  return {
    init: function () {
      ...
      jQuery("#menu").length > 0 && $("#menu").metisMenu(),
        ...
        jQuery("#show-pass1").on("click", function () {
          jQuery(this).toggleClass("active"),
            "password" == jQuery("#dlab-password1").attr("type")
              ? jQuery("#dlab-password1").attr("type", "text")
              : "text" == jQuery("#dlab-password1").attr("type") &&
                jQuery("#dlab-password1").attr("type", "password");
        }),
        jQuery("#show-pass2").on("click", function () {
          jQuery(this).toggleClass("active"),
            "password" == jQuery("#dlab-password2").attr("type")
              ? jQuery("#dlab-password2").attr("type", "text")
              : "text" == jQuery("#dlab-password2").attr("type") &&
                jQuery("#dlab-password2").attr("type", "password");
        }),
    ...
    load: function () {
      setTimeout(function () {
        ...
        jQuery("body").append('<script id="DZScript" src=""></script>');
    },
    resize: function () {
      t();
    },
